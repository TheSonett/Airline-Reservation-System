...
<html>
    ...
    <body>
        ...
        <form action="../flightMasterServlet", method="post">
            ...
            Departure Time: <input type="text" name="departure_timing" step="2"><br><br>
            Arrival Time: <input type="text" name="arrival_timing" step="2"><br><br>
            Duration: <input type="text" name="flight_duration" step="2"><br><br>
            Ticket Price: <input type="number" min="0.00" max="10000.00" name="ticket_price" step="0.01"/><br><br>
