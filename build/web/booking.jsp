                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="user_availability.jsp" class="nav-item nav-link">Check Availability</a>
                                ...
                                <a href="user_contact.jsp" class="nav-item nav-link">Contact</a>
                            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <h2><span class="text-primary text-uppercase">Your Ticket ID Is -></span></h2>
                        </div>
                    </div>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        <input id="Button1" type="button" value="Verify" onclick="alert(ValidCaptcha());"/>
                                    </div>
                                    <div class="col-md-12">
                                        <label>Before Fill Up The From, Please Enter Ticket Id And Click On Verify</label>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="name" placeholder="Your User Name">
                                            <label for="name">Your User Name</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" id="email" placeholder="Total Number Of Seats" value="3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" id="email" placeholder="Total Number Of Adults" value="2">
                                            <label for="select1">Select Number Of Adults</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" id="email" placeholder="Total Number Of Child(s)" value="1">
                                            <label for="select1">Select Number Of Child(s)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <select class="form-select" id="select3">
                                              ...
                                              <option value="3">Coach Class</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="select4">Departure Airport</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="select5">Destination Airport</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
