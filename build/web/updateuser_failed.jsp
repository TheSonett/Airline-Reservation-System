    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">User Update <span class="text-primary text-uppercase">Failed</span></h1>
                <h6 class="section-title text-center text-primary text-uppercase">May Be User Don't Exits</h6>
            </div>
        </div>
