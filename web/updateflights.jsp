                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">        
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="updateflights.jsp" class="nav-item nav-link active">Update Flights</a>
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Update Flights</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="admin_login_pass.jsp">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Update Flights</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="search_flight_by_fno">
                                <div class="row g-3">
                                    ...
                                    <h6 class="text-start text-primary text-center text-uppercase"> <small>Search Flights By Flight Name</small> </h6>
                                     
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="fname" name="flight_no" placeholder="Flight Name">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" name="from_city" id="from_city">
                                            ...
                                            <option value="aewa">aewa</option>
                                            <option value="aweaw">aweaw</option>
                                        </select>
