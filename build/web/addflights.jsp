    ...
    <div class="container-xxl bg-white p-0">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">   
                            <div class="navbar-nav mr-auto py-0">
                                <a href="admin_login_pass.jsp" class="nav-item nav-link"><small>Home</small></a>
                                <a href="addflights.jsp" class="nav-item nav-link active">Add Flights</a>
                                <a href="updateflights.jsp" class="nav-item nav-link"><small>Update Flights</small></a>
                                <a href="searchuser.jsp" class="nav-item nav-link"><small>Search User</small></a>
                                <a href="updateuser.jsp" class="nav-item nav-link "><small>Update User Details</small></a>
                                <a href="coupon.jsp" class="nav-item nav-link"><small>Coupon</small></a>
                            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3" style="margin-top: 25%;">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="add_flight_validation.jsp">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Flight Name" name="flight_name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Flight Departure City" name="from_city">
                                            <label>Enter Flight Departure City</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Flight Destination City" name="to_city">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Flight Duration 00:00 hrs" name="duration">
                                            <label>Enter Flight Duration 00:00 hrs</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Flight Arrival Time HH:MM AM/PM" name="flight_arrival_time">
                                            <label><small>Enter Flight Arrival Time HH:MM AM/PM</small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Flight Reach Time HH:MM AM/PM" id="frt" name="flight_reach_time">
                                            <label><small>Enter Flight Reach Time HH:MM AM/PM</small></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter First Class Booked Seat" name="first_class_seat_booked">
                                            <label><small>Enter First Class Booked Seat</small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter First Class Available Seat" name="first_class_seat_aval">
                                            <label><small>Enter First Class Available Seat</small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Business Class Booked Seat" name="buss_class_seat_booked">
                                            <label><small>Enter Business Class Booked Seat</small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Business Class Available Seat" name="buss_class_seat_aval">
                                            <label><small>Enter Business Class Available Seat</small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Economy Class Booked Seat" name="eco_class_seat_booked">
                                            <label><small>Enter Economy Class Booked Seat</small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" placeholder="Enter Economy Class Available Seat" name="eco_class_seat_aval">
                                            <label><small>Enter Economy Class Available Seat</small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
                                The Webpage and backend mechanism are developed by <a class="text-dark fw-medium" href="https://facebook.com/">Tanmoy Das</a> and <a class="text-dark fw-medium" href="https://facebook.com/">Joy Saha</a> hope it's attractive
                                and can be a demo of an actual airline system.
                            </p>
                        </div>
                    </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="index.jsp"> AirReserve </a>, All Right Reserved. Designed By <a class="border-bottom">Tanmoy Das</a> and <a class="border-bottom">Joy Saha</a>
                        </div>
